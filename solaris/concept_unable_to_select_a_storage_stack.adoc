...
* Si vous utilisez un environnement SAN, assurez-vous que les valeurs acceptables appropriées sont spécifiées dans le `snapdrive.conf` Fichier fourni dans la pile de matrice Solaris. Redémarrez ensuite le démon.
