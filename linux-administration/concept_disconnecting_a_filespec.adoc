...
La disposition de /mnt/fs1_0 est donnée dans les sections suivantes.
...
----
Le résultat suivant explique comment déconnecter le système de fichiers /mnt/fs_1_0 :
...
----
Après la déconnexion du système de fichiers /mnt/fs_1_0, SnapDrive pour UNIX supprime également le volume cloné SnapDrive_vol1_0_volume_clone_from_snap2_snapshot si les conditions suivantes sont remplies :
