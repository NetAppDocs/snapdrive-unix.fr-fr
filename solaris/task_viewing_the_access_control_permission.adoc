...
----
+
Cet exemple montre le type de message que vous recevez si aucun fichier d'autorisation n'est sur le grille-pain du système de stockage et la variable `_all-access-if-rbac-unspecified_` dans le `snapdrive.conf` le fichier est désactivé.
